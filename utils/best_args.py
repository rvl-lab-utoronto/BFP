...
best_args = {
    ...
    'seq-mnist': {
        ...
        'sgd_mem': {
            200: {'lr': 0.03, 'batch_size': 10, 'n_epochs': 1},
            500: {'lr': 0.03, 'batch_size': 10, 'n_epochs': 1},
        },
        'joint': {-1: {'lr': 0.03, 'batch_size': 10, 'n_epochs': 1}},
        'gdumb': {
                  200:  {'lr': 0.03, 'maxlr': 0.05, 'minlr': 5e-4, 'cutmix_alpha': 1, 'fitting_epochs': 250, 'optim_mom': 0.9, 'optim_wd': 1e-6, 'batch_size': 10, 'n_epochs': 1},
                  500: {'lr': 0.03, 'maxlr': 0.05, 'minlr': 5e-4, 'cutmix_alpha': 1, 'fitting_epochs': 250, 'optim_mom': 0, 'optim_wd': 1e-6, 'batch_size': 10, 'n_epochs': 1},
            },
        'ewc_on': {-1: {'lr': 0.03,
                        'e_lambda': 90,
                        'gamma': 1.0,
    ...
    'seq-cifar10': {'sgd': {-1: {'lr': 0.1,
                    ...
                    'ewc_on': {-1: {'lr': 0.03,
                                    ...
                                    'n_epochs': 50}},
                    'gdumb': {
                              200:  {'lr': 0.1, 'maxlr': 0.05, 'minlr': 5e-4, 'cutmix_alpha': 1, 'fitting_epochs': 250, 'optim_mom': 0.9, 'optim_wd': 1e-6, 'batch_size': 32, 'n_epochs': 1},
                              500: {'lr': 0.1, 'maxlr': 0.05, 'minlr': 5e-4, 'cutmix_alpha': 1, 'fitting_epochs': 250, 'optim_mom': 0, 'optim_wd': 1e-6, 'batch_size': 32, 'n_epochs': 1},
                        },
                    'si': {-1: {'lr': 0.03,
                                'c': 0.5,
                                'xi': 1.0,
                    ...
                    'lucir': {
                        200: {'lr': 0.03, 'lr_finetune':0.01,  'optim_mom': 0.9, 'optim_wd': 0, 'lamda_base': 5, 'k_mr':  2, 'fitting_epochs': 20, 'mr_margin': 0.5, 'lamda_mr': 1.},
    ...
    'seq-tinyimg': {'sgd': {-1: {'lr': 0.03,
                    ...
                    'fdr': {200: {'lr': 0.03,
                            ...
                            5120: {'lr': 0.03,
                                   ...
                                   'n_epochs': 100}},
                    'bic': {
                            4000: {'lr': 0.03, 'optim_mom': 0, 'optim_wd': 1e-5},
                    },
                    'lucir': {
                            4000: {'lr': 0.03, 'lr_finetune':0.01,  'optim_mom': 0.9, 'optim_wd': 0, 'lamda_base': 5, 'k_mr':  2, 'fitting_epochs': 20, 'mr_margin': 0.5, 'lamda_mr': 1., 'minibatch_size': 32, 'batch_size': 32, 'n_epochs': 100,},
                    },
                    'der': {200: {'lr': 0.03,
                                  'minibatch_size': 32,
                                  'alpha': 0.1,
    ...
    'seq-cifar100': {
        ...
        'joint': {-1: {'lr': 0.03, 'optim_mom': 0, 'optim_wd': 0, 'n_epochs': 1}},
        'er': {
            500: {'lr': 0.1, 'optim_mom': 0, 'optim_wd': 0},
            2000: {'lr': 0.1, 'optim_mom': 0, 'optim_wd': 0}
        },
        'gdumb': {
            500:  {'lr': 0.1, 'maxlr': 0.05, 'minlr': 5e-4, 'cutmix_alpha': 1, 'fitting_epochs': 250, 'optim_mom': 0.9, 'optim_wd': 1e-6, 'n_epochs': 1},
            2000: {'lr': 0.1, 'maxlr': 0.05, 'minlr': 5e-4, 'cutmix_alpha': 1, 'fitting_epochs': 250, 'optim_mom': 0, 'optim_wd': 1e-6, 'n_epochs': 1},
        },
        'lucir': {
            500: {'lr': 0.03, 'lr_finetune':0.01,  'optim_mom': 0.9, 'optim_wd': 0, 'lamda_base': 5, 'k_mr':  2, 'fitting_epochs': 20, 'mr_margin': 0.5, 'lamda_mr': 1.},
        ...
        'bic': {
            500: {'lr': 0.03, 'optim_mom': 0, 'optim_wd': 0},
            2000: {'lr': 0.03, 'optim_mom': 0, 'optim_wd': 5e-5},
        },
        'lwf': {
